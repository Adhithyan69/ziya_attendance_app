...
class AppColors {
  ...
  static const Color acVerifiedClr = Color.fromARGB(255, 56, 142, 228);
  static const Color acVerifiedMsgClr = Color.fromARGB(255, 62, 189, 68);
  //Buffering screen
  static const loaderRingClr = Color(0xFF0A73FF);
}
