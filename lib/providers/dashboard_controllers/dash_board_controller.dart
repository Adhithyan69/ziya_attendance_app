...
class DashboardController extends ChangeNotifier {
  final List<DashboardItem> _items = [
    DashboardItem(
      ...
      color: AppColors.dashboardAttendanceColor,
    ),
    DashboardItem(
      label: "Leaves",
      icon: Icons.logout,
      color: AppColors.dashboardLeavesColor,
    ),
    DashboardItem(
      label: "Holiday List",
      icon: Icons.checklist_sharp,
      color: AppColors.dashboardHolidayColor,
    ),
    DashboardItem(
      label: "Leave Status",
      icon: Icons.pie_chart,
      color: AppColors.dashboardLeavesStatusColor,
    ),
    DashboardItem(
      label: "Payslip",
      icon: Icons.my_library_books,
      color: AppColors.dashboardPayslipColor,
    ),
    DashboardItem(
      label: "Reports",
      icon: Icons.show_chart,
      color: AppColors.dashboardReportsColor,
    ),
  ];
