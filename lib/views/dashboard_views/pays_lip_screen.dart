...
import 'package:ziya_attendence_app/widgets/dottedDivider.dart';
import 'package:ziya_attendence_app/widgets/leaves_screen_appBar.dart';
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                          ...
                          Expanded(
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  _entry(
                                    TextConstants.paidDays,
                                    model.paidDays.toString(),
                                  ),
                                  _entry(
                                    TextConstants.lopDays,
                ...
                Row(
                  ...
                  children: [
                    Row(
                      children: [
                        const Text(
                          TextConstants.pfAccountNumber,
                          style: TextStyle(color: AppColors.grey, fontSize: 10),
                        ),
                        Text(
                          model.pfAccountNumber,
                          style: const TextStyle(
                            color: AppColors.black,
                            fontSize: 10,
                          ),
                ...
                const Center(
                  child: Text(
                    TextConstants.autoGeneratedNote,
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () async {
                      final controller = Provider.of<PayslipController>(
                        context,
                        listen: false,
                      );
                ...
                Container(
                  ...
                  child: Column(children: controller.historyRows),
                ),
              ],
            ),
          ),
