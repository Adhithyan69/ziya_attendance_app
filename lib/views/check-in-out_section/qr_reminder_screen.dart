...
// import 'package:ziya_attendence_app/views/check-in-out_section/punch_in_out_success_screen.dart';
...
class QrReminderScreen extends StatelessWidget {
  const QrReminderScreen({
    super.key,
    required this.time,
    required this.checkedIn,
                      ...
                      onPressed: () {
                        ...
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder:
                                (_) =>
                                    QrVerificationScreen(isCheckIn: checkedIn),
                          ),
                        );
                      },
                      child: const Text(
